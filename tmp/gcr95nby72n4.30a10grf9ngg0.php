  ...
  <div class="container" id="projetLogement">
    ...
    <div class="row">
        ...
        <div class=" col-md-4 col-sm-12">
          <div class="vignette"><img src="<?= $subrootpath ?>/img/projets/logo_habitat_humanism.jpg" alt="logo"></div>
        ...
        <div class=" col-md-8 col-sm-12">
            <div class="sliderlogement">
              ...
              <?php echo $this->render('Views/slider_projet_logement.php',NULL,get_defined_vars(),0); ?>
            </div>
         </div>
